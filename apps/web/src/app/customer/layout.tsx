...
import { LayoutDashboard, Key, Settings, CreditCard, LogOut, ShoppingBag } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between h-20">
            <div className="flex items-center gap-10">
              <Link href="/" className="flex items-center gap-3 group">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-emerald-500/60 uppercase tracking-[0.2em] -mt-1">Customer Portal</span>
                </div>
              </Link>
            ...
            <div className="flex items-center gap-3">
              <Link 
                href="/marketplace" 
                className="flex items-center gap-2 px-4 py-2 rounded-xl text-gray-400 hover:text-white hover:bg-white/[0.03] transition-all duration-200"
              >
